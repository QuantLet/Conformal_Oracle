...
\begin{document}
	...
	backward-looking: at the onset of a crisis, the trailing
	window still contains pre-crisis scores, and the correction
	...
	Rolling $\qV$ spikes during an embedded crisis regime but
	reverts to pre-crisis levels with no permanent shift
