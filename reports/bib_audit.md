...
|---|---|---|
| MISMATCH | 4 | resolved but one or more fields disagree — needs a decision |
| UNRESOLVED | 3 | DOI/arXiv id present but did not resolve |
| MANUAL | 19 | no DOI or arXiv id — verify by hand |
| OK | 30 | resolved and all compared fields agree |

## MISMATCH — full detail

### `brehmer2021properification` (article, line 212)
...
### `ansari2024chronos` (article, line 464)

Resolved via `None`.

- **PROBLEM:** given name for Shen: our 'Huishuai' vs source 'Huibin'
- note: no DOI and no arXiv id in entry — not automatically verifiable
- note: arXiv preprint found by title: arXiv:2403.07815v3 (2024, similarity 1.0)

### `das2024timesfm` (inproceedings, line 480)

Resolved via `None`.

- **PROBLEM:** author(s) in our entry not on the source record: Leber, Mathews
- note: no DOI and no arXiv id in entry — not automatically verifiable
- note: arXiv preprint found by title: arXiv:2310.10688v4 (2023, similarity 1.0)
- note: author(s) on the source record missing from our entry: Zhou

### `rasul2024lagllama` (inproceedings, line 501)

Resolved via `None`.

- **PROBLEM:** author(s) in our entry not on the source record: Bhatt, Thiele, Gasthaus
- note: no DOI and no arXiv id in entry — not automatically verifiable
- note: arXiv preprint found by title: arXiv:2310.08278v3 (2023, similarity 1.0)
- note: author(s) on the source record missing from our entry: Bhagwatkar, Bayazi, Riachi, Garg, Chapados, Drouin, Zantedeschi, Nevmyvaka, Rish

## UNRESOLVED — full detail

### `xu2024conformal` (article, line 136)
...
Resolved via `crossref:10.1002/(SICI)1096-9934(199908)19:5<583::AID-FUT6>3.0.CO;2-S`.
...
|---|---|---|---|---|---|---|
| MISMATCH | `ansari2024chronos` | Chronos: Learning the language of time series | — | Ansari / 2024 / — / — | — | given name for Shen: our 'Huishuai' vs source 'Huibin' |
