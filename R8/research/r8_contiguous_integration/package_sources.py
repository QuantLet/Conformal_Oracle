...
from build import PROJECT,SOURCE,sha,check
OUT=PROJECT/"artifacts/r8_contiguous_integration"


def main():
    check();release=PROJECT/'release';target=release/'R8_20260911_contiguous_sources.zip'
...
validation use the complete release and research/r8_contiguous_integration/README.md,
