...
OUT = PROJECT/'artifacts/review_20260909/controlled'
...
def work(model,asset):
    ...
    if model == 'Lag-Llama':
        forecast_path = PROJECT/'artifacts/review_20260909/calendar/data/lagllama'/f'{asset}.parquet'
...
def main():
    ...
    models=args.models or [m for m in MODELS if m!='Lag-Llama']
