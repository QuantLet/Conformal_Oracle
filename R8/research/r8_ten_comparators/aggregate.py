...
import numpy as np
import pandas as pd
from run import PROJECT,OUT,MODELS,ASSETS,sha,load
from run import EXT as ROOT
import methods as m
...
def main():
    ...
    exclusions=[]
    groups={'commodities':['DJCI','GLD','UNG','USO'],'crypto':['BTC','ETH'],
    ...
    (RESULTS/'complete.json').write_text(json.dumps({'pairs':240,'protocol_sha256':before['protocol_sha256'],
