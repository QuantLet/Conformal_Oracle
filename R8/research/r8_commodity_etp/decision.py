...
import numpy as np
import pandas as pd
sys.path.insert(0,str(Path(__file__).resolve().parents[2]/'research/r8_decision'))
import methods as m
...
OUT=PROJECT/'artifacts/r8_commodity_etp/decision'
...
def load(model,asset):
    ...
    if model=='Lag-Llama':fp=ROOT/'data/lagllama'/f'{asset}.parquet'
