...
OUT=PROJECT/"artifacts/r8_financial_argument"


def main():
    release=PROJECT/'release';target=release/'R8_20260911_financial_argument_sources.zip'
...
validation use the full current project and research/r8_financial_argument/README.md,
