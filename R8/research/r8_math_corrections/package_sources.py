...
OUT=PROJECT/"artifacts/r8_math_corrections"


def main():
    release=PROJECT/'release';target=release/'R8_20260911_math_corrections_sources.zip'
...
validation use the full current project and research/r8_math_corrections/README.md,
