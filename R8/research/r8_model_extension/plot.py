...
ROOT = Path(__file__).resolve().parents[2]/'artifacts/r8_model_extension/common_evaluation'
...
fig.text(.12, .909, '24 assets  ·  36,252 test observations per model  ·  1% lower quantile', fontsize=11.5)
...
ax.set_xlim(summary.QS_x10000.min()-.12, summary.QS_x10000.max()+.12); ax.set_xlabel('Mean Quantile Score × 10,000\nLower is better', labelpad=12)
