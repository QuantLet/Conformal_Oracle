...
lines += [f'1. Measured. Both estimators recover the optimism penalty 2A_0n within the 15% criterion at n in 700, 1000, 2000 on both laws: '
          ...
          'E1 undershoots at n = 250 (ratio 0.73 normal, 0.70 t5) and n = 1000, 2000 (0.87 to 0.95); E2 stays within 0.96 to 1.04 for n >= 500. '
          ...
          'through a ratio and, for b > 0, produces a mean lambda_hat below lambda* (e.g. normal n = 1000: mean lambda_hat 0.78 (E1) and 0.75 (E2) against lambda* = 0.86) '
          'with history-to-history spread (sd 0.27 (E1) and 0.26 (E2) at that cell) whose cost is not offset.',
