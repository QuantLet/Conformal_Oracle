"""Fixed external correction policies; calibration 2000–2014, test 2015–endpoint (Developed ex-US 25 universe)."""
import os
...
import numpy as np
import pandas as pd
from prepare import PROJECT,OUT,ASSETS,END,sha
...
def load(model,asset):
    ...
    assert index[nc-1].year==2014 and index[nc].year==2015 and index[-1]==pd.Timestamp(END)
