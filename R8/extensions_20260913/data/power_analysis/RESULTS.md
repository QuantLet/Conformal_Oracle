...
`int.from_bytes(sha256('20260909/panel-calendar/{block}/0')[:4], 'little')`, giving seeds
...
Both intervals exclude one half by 0.004 and 0.008. A binomial test that ignores the shared
