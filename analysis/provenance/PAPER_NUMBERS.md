...
| `\nBandGoodCells` | 264 | -- |
| `\nBandTruncCells` | 48 | -- |
| `\nBandGoodWorstRatio` | -1.947 | -- |
| `\nBandFPAtNow` | 0 | -- |
| `\nBandFPAtStrict` | 2 | -- |
| `\nBandFPAtVeryStrict` | 86 | -- |
| `\nBandTruncCaughtNow` | 48 | -- |
| `\nBandTruncCaughtVeryStrict` | 48 | -- |
| `\nBandVeryStrict` | -2.20 | -- |
| `\nUndBandVeryStrict` | 15.6 | -- |
| `\nUndBandLoose` | 34.8 | -- |
| `\nUndBandStrict` | 23.3 | -- |
| `\nBandLoose` | -1.70 | -- |
| `\nBandStrict` | -2.00 | -- |
...
| `\nMCBGapSlope` | -0.64 | -- |
| `\nMCBGapSlopeSE` | 0.08 | -- |
| `\nMCBGapSlopeSigma` | 4.3 | -- |
| `\nMCBGapMagRatio` | 1.12 | -- |
| `\nMCBRhoPlain` | 0.52 | -- |
| `\nMCBRhoConverted` | 0.52 | -- |
| `\nRuleRows` | 121{,}923 | -- |
| `\nRuleExactPct` | 99.47 | -- |
| `\nRuleFailures` | 645 | -- |
| `\nRuleFailPct` | 0.53 | -- |
...
| `\nGapPanelKupFlips` | 1 | -- |
| `\nMCPiNormalOne` | 0.0076 | -- |
| `\nMCGrnNormalOne` | 83.4 | -- |
| `\nMCQvNormalOne` | 0.00165 | -- |
| `\nMCSdNormalOne` | 0.00307 | -- |
| `\nMCPiNormalTwo` | 0.0101 | -- |
| `\nMCGrnNormalTwo` | 80.6 | -- |
| `\nMCQvNormalTwo` | 0.00030 | -- |
| `\nMCSdNormalTwo` | 0.00192 | -- |
| `\nMCPiNormalThree` | 0.0100 | -- |
| `\nMCGrnNormalThree` | 92.6 | -- |
| `\nMCQvNormalThree` | 0.00015 | -- |
| `\nMCSdNormalThree` | 0.00132 | -- |
| `\nMCPiNormalFour` | 0.0100 | -- |
| `\nMCGrnNormalFour` | 98.8 | -- |
| `\nMCQvNormalFour` | 0.00008 | -- |
| `\nMCSdNormalFour` | 0.00088 | -- |
| `\nMCPiNormalFive` | 0.0100 | -- |
| `\nMCGrnNormalFive` | 100.0 | -- |
| `\nMCQvNormalFive` | 0.00003 | -- |
| `\nMCSdNormalFive` | 0.00064 | -- |
| `\nMCRawNormal` | 0.0100 | -- |
| `\nMCPiTFiveOne` | 0.0085 | -- |
| `\nMCGrnTFiveOne` | 61.6 | -- |
| `\nMCQvTFiveOne` | 0.00758 | -- |
| `\nMCSdTFiveOne` | 0.00687 | -- |
| `\nMCPiTFiveTwo` | 0.0100 | -- |
| `\nMCGrnTFiveTwo` | 54.2 | -- |
| `\nMCQvTFiveTwo` | 0.00459 | -- |
| `\nMCSdTFiveTwo` | 0.00383 | -- |
| `\nMCPiTFiveThree` | 0.0100 | -- |
| `\nMCGrnTFiveThree` | 57.8 | -- |
| `\nMCQvTFiveThree` | 0.00405 | -- |
| `\nMCSdTFiveThree` | 0.00268 | -- |
| `\nMCPiTFiveFour` | 0.0102 | -- |
| `\nMCGrnTFiveFour` | 65.0 | -- |
| `\nMCQvTFiveFour` | 0.00369 | -- |
| `\nMCSdTFiveFour` | 0.00163 | -- |
| `\nMCPiTFiveFive` | 0.0098 | -- |
| `\nMCGrnTFiveFive` | 74.2 | -- |
| `\nMCQvTFiveFive` | 0.00372 | -- |
| `\nMCSdTFiveFive` | 0.00113 | -- |
| `\nMCRawTFive` | 0.0148 | -- |
| `\nMCPiTThreeOne` | 0.0084 | -- |
| `\nMCGrnTThreeOne` | 69.6 | -- |
| `\nMCQvTThreeOne` | 0.00868 | -- |
| `\nMCSdTThreeOne` | 0.01093 | -- |
| `\nMCPiTThreeTwo` | 0.0095 | -- |
| `\nMCGrnTThreeTwo` | 61.4 | -- |
| `\nMCQvTThreeTwo` | 0.00493 | -- |
| `\nMCSdTThreeTwo` | 0.00526 | -- |
| `\nMCPiTThreeThree` | 0.0099 | -- |
| `\nMCGrnTThreeThree` | 67.4 | -- |
| `\nMCQvTThreeThree` | 0.00424 | -- |
| `\nMCSdTThreeThree` | 0.00331 | -- |
| `\nMCPiTThreeFour` | 0.0098 | -- |
| `\nMCGrnTThreeFour` | 81.6 | -- |
| `\nMCQvTThreeFour` | 0.00365 | -- |
| `\nMCSdTThreeFour` | 0.00200 | -- |
| `\nMCPiTThreeFive` | 0.0101 | -- |
| `\nMCGrnTThreeFive` | 85.6 | -- |
| `\nMCQvTThreeFive` | 0.00360 | -- |
| `\nMCSdTThreeFive` | 0.00142 | -- |
| `\nMCRawTThree` | 0.0138 | -- |
| `\nMCPiSkewOne` | 0.0083 | -- |
| `\nMCGrnSkewOne` | 36.4 | -- |
| `\nMCQvSkewOne` | 0.02112 | -- |
...
| `\nMCQvSkewTwo` | 0.01383 | -- |
| `\nMCSdSkewTwo` | 0.00843 | -- |
| `\nMCPiSkewThree` | 0.0105 | -- |
| `\nMCGrnSkewThree` | 10.8 | -- |
| `\nMCQvSkewThree` | 0.01249 | -- |
| `\nMCSdSkewThree` | 0.00479 | -- |
| `\nMCPiSkewFour` | 0.0101 | -- |
| `\nMCGrnSkewFour` | 3.2 | -- |
| `\nMCQvSkewFour` | 0.01220 | -- |
| `\nMCSdSkewFour` | 0.00302 | -- |
| `\nMCPiSkewFive` | 0.0101 | -- |
| `\nMCGrnSkewFive` | 0.4 | -- |
| `\nMCQvSkewFive` | 0.01214 | -- |
| `\nMCSdSkewFive` | 0.00222 | -- |
| `\nMCRawSkew` | 0.0233 | -- |
| `\nMCPiMixOne` | 0.0084 | -- |
| `\nMCGrnMixOne` | 68.4 | -- |
| `\nMCQvMixOne` | 0.01451 | -- |
...
| `\nMCPiMixThree` | 0.0098 | -- |
| `\nMCGrnMixThree` | 79.8 | -- |
| `\nMCQvMixThree` | 0.00727 | -- |
| `\nMCSdMixThree` | 0.00622 | -- |
| `\nMCPiMixFour` | 0.0100 | -- |
| `\nMCGrnMixFour` | 90.8 | -- |
| `\nMCQvMixFour` | 0.00631 | -- |
| `\nMCSdMixFour` | 0.00388 | -- |
...
| `\nMCSdMixFive` | 0.00286 | -- |
| `\nMCRawMix` | 0.0124 | -- |
| `\nMCCorPiMaxDev` | 0.0006 | -- |
| `\nMCCorPiSmallLo` | 0.0076 | -- |
...
| `\nMCOverFour` | 0.0003 | -- |
| `\nMCOverFive` | 0.0001 | -- |
| `\nTLTauYellowOverAlpha` | 3.60 | -- |
| `\nMCPopNormal` | 0.0100 | -- |
| `\nMCPopTFive` | 0.0150 | -- |
| `\nMCPopTThree` | 0.0136 | -- |
| `\nMCPopSkew` | 0.0233 | -- |
| `\nMCPopMix` | 0.0125 | -- |
| `\nMCNormalApproxPP` | 2.5 | -- |
| `\nLevelBound` | 198 | -- |
...
| `\nWSweepBound` | 198 | -- |
| `\nHarnessDefectsInstrument` | 6 | -- |
| `\nHarnessDefectsObject` | 4 | -- |
| `\nHarnessDefectsTotal` | 10 | -- |
| `\nMLCells` | 40 | -- |
| `\nMLDates` | 200 | -- |
| `\nMLAssets` | 4 | -- |
| `\nMLLeafSettings` | 5 | -- |
